        ...
        <div className={styles.split}>
            <div>
                <div className={styles.codeBlock}>
                    <span className={styles.dir}>gcp-iac/</span>
                    <br />
                    ...
                    <br />
                    |  '- <span className={styles.mod}>org-policy/</span>
                    <br />
                    |
                    <br />
                    '- README.md
            ...
            <div className={styles.stepper}>
                ...
                <div className={styles.step}><div className={styles.stepNum}>02</div><div className={styles.stepBody}><h3>Validate</h3><p>Run formatting, validation, linting, and policy checks.</p><code>terraform fmt · terraform validate · tflint · gcloud org-policies list</code></div></div>
                ...
                <div className={styles.step}><div className={styles.stepNum}>05</div><div className={styles.stepBody}><h3>Deploy</h3><p>Apply approved changes and promote workloads through Cloud Deploy delivery pipelines.</p></div></div>
