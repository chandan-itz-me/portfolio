        ...
        <div className={styles.split}>
            <div>
                <div className={styles.codeBlock}>
                    <span className={styles.dir}>aws-iac/</span>
                    <br />
                    ...
                    <br />
                    |  |- <span className={styles.mod}>load-balancer/</span>
                    <br />
            ...
            <div className={styles.stepper}>
                ...
                <div className={styles.step}><div className={styles.stepNum}>02</div><div className={styles.stepBody}><h3>Validate</h3><p>Run formatting, validation, linting, and policy checks.</p><code>terraform fmt · terraform validate · tflint</code></div></div>
                <div className={styles.step}><div className={styles.stepNum}>03</div><div className={styles.stepBody}><h3>Plan</h3><p>Generate a Terraform execution plan to make changes visible before deployment.</p></div></div>
                ...
                <div className={styles.step}><div className={styles.stepNum}>05</div><div className={styles.stepBody}><h3>Apply</h3><p>Apply approved changes using controlled execution and protected state.</p></div></div>
