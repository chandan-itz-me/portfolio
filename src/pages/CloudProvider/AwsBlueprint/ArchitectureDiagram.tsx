                ...
                <div className={styles.railLayout}>
                    ...
                    <div className={styles.tiers}>
                        <div className={styles.tier}>
                            <div className={styles.tierLabel}><b>01 - Edge &amp; Presentation</b> · DNS, CDN, WAF, Ingress</div>
                        ...
                        <div className={styles.tier}>
                            <div className={styles.tierLabel}><b>02 - Application</b> · Stateless services &amp; workers</div>
                            <div className={styles.nodeRow}>
                        ...
                        <div className={styles.tier}>
                            <div className={styles.tierLabel}><b>03 - Data</b> · Persistence, cache, objects</div>
                            <div className={styles.nodeRow}>
